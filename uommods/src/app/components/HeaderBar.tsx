            ...
            >
                <div className="flex flex-col h-full justify-between">
                    ...
                    <div className="p-4 border-t text-sm">
                        {user ? (
                            <div>
                                <div className="mb-2 text-gray-700 font-semibold">{decodedName}</div>
                                <Link href="/settings" onClick={() => setSidebarOpen(false)} className="block py-1 hover:text-blue-600">
                                    Settings
                                </Link>
                                <button onClick={logout} className="block py-1 text-left text-red-600 hover:text-red-800">
                                    Logout
                                </button>
                            </div>
                        ) : (
                            <Link href="/login" onClick={() => setSidebarOpen(false)} className="text-blue-600 hover:underline">
                                Log in
                            </Link>
                        )}
                    </div>
